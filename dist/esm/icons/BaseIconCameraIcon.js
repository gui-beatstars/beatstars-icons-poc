...
const BaseIconCameraIcon = forwardRef(
  ({ size = 24, color = "currentColor", strokeWidth, className, style, ...rest }, ref) => /* @__PURE__ */ jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx("path", { stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M12 16.5a4 4 0 1 0 0-8 4 4 0 0 0 0 8" })
      ]
    }
  )
);
...
export {
  BaseIconCameraIcon_default as default
};
